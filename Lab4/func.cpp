...
const Bignum operator*(const Bignum& left, const Bignum& right){
    ...
    //cout << "after reverse_string: ls = "<< ls << endl;
    //cout << "after reverse_string: rs = "<< rs << endl;
...
char minus_char(char a, char b, int& mark){
    int an = char_to_int(a);
    int bn = char_to_int(b);
  /*  cout << "minus_char: a is "<< a <<", an is " << an << endl;
    cout << "minus_char: b is "<< b <<", bn is " << bn << endl;
    cout << "minus_char: mark is " << mark << endl;
*/
    if((an + mark) >= bn){
        int diff = an + mark - bn;
        mark = 0;
...
//    cout << "multiply_string_char: pro " << pro << endl;
    return pro;
}
...
Bignum& divide_string(string a, string b, Bignum& res){
    boom ++;
   // cout << "divide_string: a: " << a << ", b: " << b << endl;
   // cout << "divide_string: res " << res.num << endl;
   /* if(boom > 100){
        cout << "BOOM" << endl;
        return res;
    }
*/
  ...
  //  cout << "divide_string: l1: " << l1 << ", l2: " << l2 << endl; 
    ...
    do{
      ...
      //  cout << "count: " << count << endl;
        ...
        cout << "is_bigger" << is_bigger(l1,tmp) << endl;
        */
   ...
   // cout << "count: " << count << endl;
    ...
    //cout << "divide_string: count_num: " << count_num.num << endl;
    res = res + count_num;
    //cout << "res.num: " << res.num << endl;
    Bignum tmp_num = count_num * b_num;
    //cout << "tmp_num.num: " << tmp_num.num << endl;
    Bignum aa = a_num - tmp_num;
    //cout << "aa.num: " << aa.num << endl;
